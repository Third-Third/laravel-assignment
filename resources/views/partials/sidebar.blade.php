<div class="sidebar bg-dark text-white p-3" style="width: 250px; height: 100vh; position: fixed; top: 0; left: 0;">
    <h4 class="text-center mb-4 fw-bold">Menu</h4>
    ...
    <ul class="nav flex-column">
        ...
        <li class="nav-item mb-2">
            <a href="{{ route('categories.index') }}"
                ...
                <span class="fw-semibold" style="font-size: 15px;">Item Master</span>
            </a>
        </li>
        ...
        <li class="nav-item">
            <a class="nav-link text-white d-flex justify-content-between align-items-center {{ $isUserActive ? 'text-primary fw-bold' : 'collapsed' }}"
                ...
                <span class="d-flex align-items-center">
                    ...
                    <span class="fw-semibold" style="font-size: 15px;">Users Management</span>
                </span>
