...
<nav class="navbar navbar-expand-lg navbar-light bg-light ps-3" style="margin-left: 250px; border-bottom: 1px solid black;">
    <div class="container-fluid">
        <span class="navbar-brand">
            <img src="{{ asset('img/npit.png') }}" alt="NPIT Logo" style="height: 40px; width: auto;">
        </span>
