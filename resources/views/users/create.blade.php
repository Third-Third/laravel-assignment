        ...
        <div class="col-md-8">
            <div class="card border rounded shadow-sm">
                <div class="card-header bg-dark text-white">
                    <h5 class="mb-0" style="font-family: AKbalthom Superhero; color: white;">Add New User</h5>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('users.store') }}">
                        ...
                        <div class="mb-3 p-3 border rounded bg-light">
                            <div class="form-check">
                                <input style="border: 1px solid black;" class="form-check-input" type="checkbox" id="showPassword" onclick="togglePasswordVisibility()">
